...
static STRNNCOLLSP_CHAR_PARAM strnncollsp_char_utf8mb3_unicode_ci[]=
{
  ...
  {{CSTR("a" "\x01")},       {CSTR(UTF8_auml)},                 0,  0},
  {{CSTR("a" "\x01")},       {CSTR(UTF8_auml)},                 1,  0},
  {{CSTR("a" "\x01")},       {CSTR(UTF8_auml)},                 2,  0},
  {{CSTR("a" "\x01")},       {CSTR(UTF8_auml)},                 3,  0},
  {{CSTR("a" "\x01")},       {CSTR(UTF8_auml)},               100,  0},
...
static STRNNCOLLSP_CHAR_PARAM strnncollsp_char_utf8mb3_unicode_nopad_ci[]=
{
  ...
  {{CSTR("a" "\x01")},       {CSTR(UTF8_auml)},                 0,  0},
  {{CSTR("a" "\x01")},       {CSTR(UTF8_auml)},                 1,  0},
  {{CSTR("a" "\x01")},       {CSTR(UTF8_auml)},                 2, -1},
  {{CSTR("a" "\x01")},       {CSTR(UTF8_auml)},                 3, -1},
  {{CSTR("a" "\x01")},       {CSTR(UTF8_auml)},               100, -1},
